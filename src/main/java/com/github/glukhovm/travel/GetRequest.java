...
public class GetRequest {
    private static String requestURL = "https://api.skypicker.com/flights?fly_from=CEK&fly_to=LED&date_from=01/06/2020&date_to=01/07/2020&partner=picky&curr=RUB&limit=1";
    ...
    public static void main(String[] args) {
        try (
            ...
            if (entity != null) {
                ...
                testDto testDto = objectMapper.readValue(data, testDto.class);
